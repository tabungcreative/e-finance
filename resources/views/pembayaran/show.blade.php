            ...
            <div class="card-body">
                <table class="table table-striped table-hover">
                    ...
                    <tr>
                        ...
                        <td scope="col">{{ $pembayaran->jenisPembayaran->nama_pembayaran }}</td>
                    </tr>
                    <tr>
                ...
                <a href="{{ route('admin.pembayaran.cetakKwitansi', $pembayaran->id) }}" target="_blank" class="btn btn-sm btn-success">Cetak Kwitansi</a>
            </div>
        </div>
    </div>
</div>
